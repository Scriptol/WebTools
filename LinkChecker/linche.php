...
{
   echo "\n";
   echo "Link Checher - (c) 2008-2015 Scriptol.com - Freeware.", "\n";
   echo "----------------------------------------------------", "\n";
   echo "Syntax:", "\n";
...
function main($argc,$argv)
{
   ...
   show("$brocount broken links, $redcount redirect, in $counter links checked in $sp pages.");
   return 0;
}
